...
public class MainActivity extends AppCompatActivity {
    ...
    static final int PHOTO_PERMISSION = 3;
    ...
    // name of the file that is saved by our camera
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_load.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MainActivity.this, Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getPath(), Toast.LENGTH_SHORT).show();
                // create an intent
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO && resultCode == RESULT_OK) {
            ...
            // show the file name in the tv_message
    ...
    private void dispatchTakePictureIntent() {
            ...
            if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                ...
                try {
                    ...
                    Toast.makeText(this, "Could not make the file.", Toast.LENGTH_SHORT).show();
                }
